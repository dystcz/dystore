...
class OrderSchema extends Schema
{
    ...
    public function includePaths(): iterable
    {
        return [
            ...
            'dygital_lines.purchasable.prices',
            'dygital_lines.purchasable.price',
            'dygital_lines.purchasable.lowest_price',
            'dygital_lines.purchasable.highest_price',
            ...
            'physical_lines.purchasable.price',
            'physical_lines.purchasable.lowest_price',
            'physical_lines.purchasable.highest_price',
            ...
            'product_lines.purchasable.lowest_price',
            'product_lines.purchasable.highest_price',
